...
test.describe('CLM YouTube Viewer Component Test', () => {
  ...
  test('should load and display YouTube viewer component correctly', async ({ page }, testInfo) => {
    ...
    const youtubeButton = page.locator('button:has-text("YouTube Video Viewer")');
    ...
    const componentIframe = page.frameLocator('iframe[data-component-id="youtube-viewer"]');
    
    // Check if YouTube viewer component content is loaded in iframe
    const youtubeHeading = componentIframe.locator('h2:has-text("YouTube Video Viewer")');
    ...
    const iframe = page.locator('iframe[data-component-id="youtube-viewer"]');
  ...
  test('should handle component failure gracefully', async ({ page }, testInfo) => {
    ...
    const crashTestButton = page.locator('button:has-text("Intentional Failure Component")');

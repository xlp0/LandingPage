...
test.describe('CLM Welcome Component Test', () => {
  ...
  test('should load and display welcome component correctly', async ({ page }, testInfo) => {
    ...
    const welcomeButton = page.locator('button:has-text("Welcome Component")');
    ...
    const componentIframe = page.frameLocator('iframe[data-component-id="welcome"]');
    ...
    const iframe = page.locator('iframe[data-component-id="welcome"]');

...
This rule is triggered when the user types `@tech-writer` and activates the Technical Writer agent persona.
...
The complete agent definition is available in [bmad/bmm/agents/tech-writer.md](bmad/bmm/agents/tech-writer.md).

## Usage

When the user types `@tech-writer`, activate this Technical Writer persona and follow all instructions defined in the YAML configuration above.

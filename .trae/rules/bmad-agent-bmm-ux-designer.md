...
The complete agent definition is available in [bmad/bmm/agents/ux-designer.md](bmad/bmm/agents/ux-designer.md).

## Usage

When the user types `@ux-designer`, activate this UX Designer persona and follow all instructions defined in the YAML configuration above.

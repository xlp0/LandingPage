...
style = {{
    ...
    <p>⬆️⬇️⬅️➡️ or WASD to move </p>
        < p > SPACE to interact • ESC to pause </p>
            </div>
            </div>
    );
  }
...
if (gameState === 'victory') {
    ...
    <style>{`
        ...
        `}</style>
    < div style = {{ fontSize: '100px', animation: 'victoryGlow 2s infinite' }}>🏆</div>
...
if (gameState === 'paused') {
    ...
    <h1 style={ { fontSize: '3rem', color: '#FFD700' } }>⏸️ PAUSED </h1>
        < button
...
<div style={
    ...
    < div style = {{ position: 'absolute', top: 10, right: 10, fontSize: '40px', opacity: 0.3 }}>🗿</div>
        < div style = {{ position: 'absolute', bottom: 10, left: 10, fontSize: '30px', opacity: 0.3 }}>🌴</div>
            < div style = {{ position: 'absolute', top: 10, left: 10, fontSize: '30px', opacity: 0.3 }}>🌴</div>
        ...
        <span>⭐</span>
            < span style = {{ fontWeight: 'bold', color: '#FFD700' }}> { score } </span>
                ...
                < div style = {{ fontSize: '1.5rem' }}>
                    { dayTime< 25? '🌅' : dayTime< 50? '☀️' : dayTime< 75? '🌆' : '🌙'}
                    </div>
                    </div>
                    </div>
...
<div style={
    ...
    WASD / Arrows: Move • SPACE: Talk • ESC: Pause
        </div>

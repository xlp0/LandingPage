...
This command activates the UX Designer agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/ux-designer.md](bmad/bmm/agents/ux-designer.md)

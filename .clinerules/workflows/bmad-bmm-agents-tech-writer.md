...
<activation critical="MANDATORY">
  ...
  <step n="4">CRITICAL: Load COMPLETE file /Users/bkoo/Documents/Development/GovTech/PKC/LandingPage/src/modules/bmm/workflows/techdoc/documentation-standards.md into permanent memory and follow ALL rules within</step>
  <step n="5">Load into memory /Users/bkoo/Documents/Development/GovTech/PKC/LandingPage/bmad/bmm/config.yaml and set variables</step>
  ...
  <menu>
    ...
    <item cmd="*document-project" workflow="/Users/bkoo/Documents/Development/GovTech/PKC/LandingPage/bmad/bmm/workflows/document-project/workflow.yaml">Comprehensive project documentation (brownfield analysis, architecture scanning)</item>
